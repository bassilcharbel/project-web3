...
<body style="background-image: url(./photos/dfront.jpg); background-repeat: no-repeat; background-size: 100%;">
  ...
  <div class="container mt-5">
    <div class="row justify-content-center">
      <div class="col-md-6">
        <div class="card p-4">
          <h1 class="card-title text-center" style="color:#DC5F00;">Sign Up</h1>
          ...
          <form id="signUpForm" class="lform" method="post" action="register.php">
            ...
            <div class="mb-3">
              ...
              <input type="text" class="form-control" id="lastName" name="Lname" placeholder="L Name" required />
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
              ...
              <input type="password" class="form-control" id="confirmPassword" name="confirm_pass" placeholder="Password" required />
            </div>
            <div class="d-grid">
              <input type="submit" class="btn btn-primary" style="background-color: #DC5F0c; color:#eee;" value="Sign Up">
            </div>
          </form>
        </div>
      </div>
