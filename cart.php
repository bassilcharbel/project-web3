...
<body>
  ...
  <div class="container">
    <div class="row justify-content-center">
      <div class="col-lg-10">
        <!--alert-->
        <div sttle="display:none <?php if(isset($_SESSION['showAlert'])){echo $_SESSION['showAlert'];} else{echo'none';} unset($_SESSION['showAlert']);?>" class="alert alert-success alert-dismissible mt3">
          ...
          <table class="table table-bordered table-striped text-center">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <a href="action.php?remove=<?= $row['id'] ?>" style="background-color:#DC5F00;border-color:DC5F00;"class="text-danger lead" onclick="return confirm('Are you sure want to remove this item?');"><i class="fas fa-trash-alt"></i></a>
                </td>
              </tr>
